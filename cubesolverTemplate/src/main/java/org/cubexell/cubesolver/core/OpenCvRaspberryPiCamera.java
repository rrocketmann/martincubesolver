...
public class OpenCvRaspberryPiCamera implements CubeColorInspector{
    ...
    public char[][][] inspect() {
        ...
        //TODO take a picture using the outputImage variable as the name
        captureImage();
    ...
    public char[][] inspectBackFace(char center) {
        ...
        return new char[][]{//returns a 2 dimensional array of the colors of the back face
                {
                        findColor(700,400,90,85),//gets the color of the top-left piece of the back face. coordinates are of the top-left corner, width, and height.
                        findColor(960,270,240,90),
                        findColor(1190,35,290,90),
                },
                {
                        findColor(850,625,140,250),
                        center,
    ...
    public static char classifyColor(Mat square) {
        ...
        List<Integer> listOfL = new ArrayList<>();//initialized a list that will hold all of the l values of the pixles
